package com.plum.pagingtest.ui.addfooter
...
import com.plum.pagingtest.ui.addfooter.adapter.FooterAdapter
import com.plum.pagingtest.ui.addfooter.adapter.HeaderAdapter
import com.plum.pagingtest.ui.addfooter.adapter.RepositoryListAdapter
 ...
 * @Description: 仓库列表页面
 */
class AddFooterAndHeaderActivity : AppCompatActivity() {
    ...
    private fun initRecyclerView() {
        ...
        binding.recyclerView.adapter = adapter.withLoadStateHeaderAndFooter(
            header = HeaderAdapter { adapter.retry() },
